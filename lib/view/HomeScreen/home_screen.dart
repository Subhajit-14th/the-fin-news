  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Consumer<HomeProvider>(builder: (context, homeProvider, child) {
        if (homeProvider.isHomeDataLoading) {
          return Center(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<ScreenRouteProvider>().setScreenRoute(1);
                    },
                    child: Row(
                      children: [
                        Text(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<ScreenRouteProvider>().setScreenRoute(2);
                    },
                    child: Row(
                      children: [
                        Text(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<ScreenRouteProvider>().setScreenRoute(3);
                    },
                    child: Row(
                      children: [
                        Text(
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () {
                      context.read<ScreenRouteProvider>().setScreenRoute(4);
                    },
                    child: Row(
                      children: [
                        Text(
